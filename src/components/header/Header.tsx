...
import enter from "../../img/search.svg";
...
const Header = () => {
    ...
    const debounceFn = useCallback(_debounce((search: string) => {
        ...
        <>
            <header className={cl.header}>
                <div className={cl.header__container}>
                    ...
                    <input onChange={e => onChangeSearch(e)} placeholder='Что ищем, Док?' value={searchValue} className={cl.search__input}/>
                    <span title='Очистить строку' onClick={() => onClickClearSearch()} className={cl.block__search__clear}>⛌</span>
                    <img className={cl.search__button} alt='Поиск' src={enter} title='Поиск' />
                    </div>
                    </div>
                </div>
            </header>
