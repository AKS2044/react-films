...
import posterMenu from '../src/img/posterMenu.jpg';
    ...
    <div>
      <header className='header'>
        <div className='header-container'>
          <div className='logo'>LogoSuite</div>
          <div className='header-menu'>
            <div className='header-link-block'>
              <a href="/" className='header-link'>Случайный</a>
              <a href="/" className='header-link'>Премьеры</a>
              <a href="/" className='header-link'>Новинки</a>
            </div>
            ...
            <div className='block-search'>
              ...
              <svg className='search-button' width="22" height="16" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='slider'>
        <div className='border-slider'></div>
          ...
          <svg className='slider-left' width="31" height="38" viewBox="0 0 31 38" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='group-slider'>
              {postsSlider.map((post, index) =>
                <div key={index} className='post-block'>
                  <a href='/'>
                  <img className='poster-slider' src={post.photo} alt="Название фильма(год)" title="Название фильма(год)" />
                  </a>
                  <div className='film-name-slider'>{post.name}</div>
                </div>).slice(0, 7)}
            </div>
            <svg className='slider-right' width="31" height="38" viewBox="0 0 31 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='left-block'>
              <div className='menu-block'>
                ...
                <div className='content-menu'>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Фантастика<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Триллер<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Документальный<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Приключения<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Фэнтези<small>(1тыс)</small></a>
                  <a href='/' className='content-link'>Боевик<small>(1тыс)</small></a>
                </div>
              </div>
              <div className='menu-block'>
                <div className='title-menu'>Скоро на сайте</div>
                <div className='border-menu'></div>
                <div className='content-menu'>
                  <div className='post-menu-block'>
                    <a href='/'><img className='poster-menu' src={posterMenu} alt="Название фильма(год)" title="Название фильма(год)" /></a>
                    <div className='content-block-menu'>
                      <div className='content-text-menu'>Название</div>
                      <div className='content-text-menu'>Год: 2011</div>
                      <div className='content-text-menu'>Рейтинг: 4.5</div>
                      <div className='content-text-menu'>Рейтинг: 6.4</div>
                      <div className='content-text-menu'>Рейтинг: 3.2</div>
                    </div>
                  </div>
                  <div className='post-menu-block'>
                    <a href='/'><img className='poster-menu' src={posterMenu} alt="Название фильма(год)" title="Название фильма(год)" /></a>
              ...
              <div className='menu-block'>
                <div className='title-menu'>Рекомендуем</div>
                <div className='border-menu'></div>
                <div className='content-menu'>
                <div className='post-menu-block'>
                  <a href='/'><img className='poster-menu' src={posterMenu} alt="Название фильма(год)" title="Название фильма(год)" /></a>
      ...
      <footer className='footer'>
        <div className='footer__logo'>LogoSuite - какой-то слогон</div>
      </footer>
    </div>
  );
}
